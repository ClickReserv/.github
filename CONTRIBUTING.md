...
Thanks for your interest in contributing to a ClickReserv project.
...
**Don't open a public issue.** See [SECURITY.md](./SECURITY.md) and email security@reserv.click.
